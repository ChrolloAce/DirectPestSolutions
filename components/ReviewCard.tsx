...
export default function ReviewCard({ review }: ReviewCardProps) {
  ...
  return (
    <article className="relative h-full rounded-none bg-white border-2 border-white shadow-card p-5 pt-8">
      ...
      <div className="absolute top-0 left-4 h-10 w-10 rounded-full border-2 border-brand-red bg-white flex items-center justify-center transform -translate-y-1/2">
        <Image 
